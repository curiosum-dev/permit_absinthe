defmodule Permit.Absinthe.Middleware.DataloaderSetup do
  ...
  ```elixir
  field :me, :user do
    middleware Permit.Absinthe.Middleware.DataloaderSetup, repo: MyApp.Repo
  ...
  - `:repo` - The Ecto repository to use for database queries (required)
  ...
  def call(resolution, opts) do
    repo = Keyword.get(opts, :repo) |> IO.inspect(label: "repo")
